...
UIKIT_EXTERN NSString *const FXFormFieldTypeRate;  //rateview
...
@interface FXFormstarviewCell : FXFormBaseCell

//@property (nonatomic, readonly) FloatRatingView *viewrating;
