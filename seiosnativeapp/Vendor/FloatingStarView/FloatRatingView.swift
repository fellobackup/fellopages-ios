...
open class FloatRatingView: UIView {
    ...
    */
    ...
    override open func layoutSubviews()
    {
        ...
        {
            let desiredImageWidth = (self.frame.size.width / CGFloat(self.emptyImageViews.count))-3
           // let maxImageWidth = max(self.minImageSize.width, desiredImageWidth)
            ...
            let imageViewSize = self.sizeForImage(emptyImage, inSize: CGSize(width: desiredImageWidth, height: maxImageHeight))
