...
- (NSString *)getText {
     ...
     NSString * str = [self.editorView stringByEvaluatingJavaScriptFromString:@"zss_editor.getText();"];
    NSString *value = [[NSUserDefaults standardUserDefaults] stringForKey:@"blogandclassified"];
...
//    ? : info[UIImagePickerControllerInfoKey.originalImage];
    UIImage *selectedImage = info[UIImagePickerControllerEditedImage] ? : info[UIImagePickerControllerLivePhoto];
