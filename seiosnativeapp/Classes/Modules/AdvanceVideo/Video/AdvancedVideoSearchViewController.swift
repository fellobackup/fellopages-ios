...
class AdvancedVideoSearchViewController: UIViewController , UITableViewDataSource, UITableViewDelegate , UISearchBarDelegate, TTTAttributedLabelDelegate,UIWebViewDelegate {
...
//        searchBar.setTextColor(textColorPrime)
        ...
        let filter = UIBarButtonItem( title: fiterIcon , style: UIBarButtonItemStyle.plain , target:self , action: #selector(AdvancedVideoSearchViewController.filter))
