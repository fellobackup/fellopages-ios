...
class ChannelSearchViewController: UIViewController , UITableViewDataSource, UITableViewDelegate , UISearchBarDelegate, TTTAttributedLabelDelegate,UIWebViewDelegate {
                   ...
                   // self.tblAutoSearchSuggestions.isHidden = true
                    ...
                    if msg{
                        ...
                        if self.channelResponse.count == 0{
                            ...
                            self.view.makeToast(NSLocalizedString("You do not have any channels. Get started by creating a new entry.", comment: ""), duration: 5, position: "bottom")
