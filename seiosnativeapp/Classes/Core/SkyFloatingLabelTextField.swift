...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @IBInspectable dynamic open var placeholderColor: UIColor = textColorMedium {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    @IBInspectable dynamic open var titleColor = buttonColor {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var lineColor = textColorLight {
        didSet {
            updateLineView()
        }
    }
    ...
    @IBInspectable dynamic open var errorColor = textColorLight{
        didSet {
            updateColors()
        }
    }
    ...
    @IBInspectable dynamic open var selectedTitleColor = buttonColor {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var selectedLineColor = textColorLight {
        didSet {
            updateLineView()
        }
    }
    ...
    */
    ...
    fileprivate func createTitleLabel() {
        ...
        titleLabel.font = UIFont(name: "fontAwesome", size: FONTSIZEMedium)//titleFont
